"""
Financial Agent for InvestIQ system.
...
class FinancialAgent:
    ...
    def get_market_info(self, symbol: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'exchange_hints': ['NSE', 'BSE'] if is_indian else ['NASDAQ', 'NYSE', 'TSX']
        }
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        if (screener_health.get('status') != 'healthy' or 
            alphavantage_health.get('status') != 'healthy'):
