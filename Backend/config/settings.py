"""
Configuration settings for FinSight financial agent system.
...
class Settings(BaseSettings):
    ...
    debug: bool = True
    app_name: str = "FinSight Financial Agent"
    version: str = "2.0.0"
    ...
    use_optimized_agent: bool = (
        False  # Hybrid agent with manual planning (3-4 LLM calls)
    )
    use_autonomous_agent: bool = (
        True  # Autonomous agent with intelligent batching (3-4 LLM calls)
    )
