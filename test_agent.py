"""
Test script for InvestIQ LangGraph Financial Agent.
...
def test_tools():
    ...
    print("Testing InvestIQ Financial Agent Tools")
    print("=" * 50)
    ...
    try:
        ...
        print(f"   ✓ Analysis for: {analysis_result.get('symbol')} - {analysis_result.get('company_name')}")
        print(f"   ✓ Key insights generated: {len(analysis_result.get('insights', {}))}")
...
def main():
    """Run all tests."""
    print("InvestIQ LangGraph Financial Agent - Test Suite")
    print("=" * 60)
    ...
    tests = [
        test_tools,
        test_indian_vs_global_detection,
    ...
    if passed == total:
        ...
        print("3. Visit http://localhost:8000/docs to see the interactive API documentation")
    else:
