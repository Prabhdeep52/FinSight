...
export const FinancialDashboard: React.FC<FinancialDashboardProps> = ({ stocks }) => {
  ...
  const comparisonResults = useMemo(() => {
    ...
    const revenueComp = compareHigherBetter(stock1Metrics.income.revenue, stock2Metrics.income.revenue);
    stock1Results.revenue = revenueComp.stock1Result;
    stock2Results.revenue = revenueComp.stock2Result;

    const grossMarginComp = compareHigherBetter(stock1Metrics.income.grossMargin, stock2Metrics.income.grossMargin);
    stock1Results.grossMargin = grossMarginComp.stock1Result;
    stock2Results.grossMargin = grossMarginComp.stock2Result;

    const operatingMarginComp = compareHigherBetter(stock1Metrics.income.operatingMargin, stock2Metrics.income.operatingMargin);
    ...
    const netMarginComp = compareHigherBetter(stock1Metrics.income.netMargin, stock2Metrics.income.netMargin);
    stock1Results.netMargin = netMarginComp.stock1Result;
    stock2Results.netMargin = netMarginComp.stock2Result;

    const ebitdaComp = compareHigherBetter(stock1Metrics.income.ebitda, stock2Metrics.income.ebitda);
    stock1Results.ebitda = ebitdaComp.stock1Result;
    stock2Results.ebitda = ebitdaComp.stock2Result;

    // Balance sheet comparisons
    const currentRatioComp = compareHigherBetter(stock1Metrics.balance.currentRatio, stock2Metrics.balance.currentRatio);
    stock1Results.currentRatio = currentRatioComp.stock1Result;
    stock2Results.currentRatio = currentRatioComp.stock2Result;

    const debtToEquityComp = compareLowerBetter(stock1Metrics.balance.debtToEquity, stock2Metrics.balance.debtToEquity);
    stock1Results.debtToEquity = debtToEquityComp.stock1Result;
    stock2Results.debtToEquity = debtToEquityComp.stock2Result;

    // Cash flow comparisons
    const fcfComp = compareHigherBetter(stock1Metrics.cashFlow.freeCashFlow, stock2Metrics.cashFlow.freeCashFlow);
    stock1Results.freeCashFlow = fcfComp.stock1Result;
    stock2Results.freeCashFlow = fcfComp.stock2Result;

    const fcfMarginComp = compareHigherBetter(stock1Metrics.cashFlow.fcfMargin, stock2Metrics.cashFlow.fcfMargin);
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <EarningsTable 
            earningsData={stock1Metrics.earnings}
          />
        </div>
        ...
        <div className="space-y-6">
          ...
          <EarningsTable 
            earningsData={stock2Metrics!.earnings}
          />
        </div>
      </div>
    </div>
